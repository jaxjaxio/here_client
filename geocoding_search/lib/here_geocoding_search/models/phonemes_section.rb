...
module HereGeocodingSearch
  class PhonemesSection
    ...
    def self.openapi_types
      {
        :'place_name' => :'Array<Phoneme>',
        :'country_name' => :'Array<Phoneme>',
        :'state' => :'Array<Phoneme>',
        :'county' => :'Array<Phoneme>',
        :'city' => :'Array<Phoneme>',
        :'district' => :'Array<Phoneme>',
        :'subdistrict' => :'Array<Phoneme>',
        :'street' => :'Array<Phoneme>',
        :'block' => :'Array<Phoneme>',
        :'subblock' => :'Array<Phoneme>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `HereGeocodingSearch::PhonemesSection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `HereGeocodingSearch::PhonemesSection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'country_name')
        if (value = attributes[:'country_name']).is_a?(Array)
    ...
    def hash
      [place_name, country_name, state, county, city, district, subdistrict, street, block, subblock].hash
    end
